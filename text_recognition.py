...
def main(file_id):
    ...
    #file_id = "66809069904484164748518621889143522161"
    path = '/home/andrey/Hackaton/price-reader-prototype/recognition api/%s.jpg' % (file_id)
    #path = '/home/andrey/Hackaton/asd/opencv-text-recognition/test.jpg'
    args["image"] = path
    ...
    image = cv2.resize(cv2.imread(args["image"]), dsize = (585, 1040))
    orig = image.copy()
...
"""
    ...
    #print("startY: ", startY)
    #print("endY: ", endY)
    if (endY - startY) > max_heigh:
        max_heigh = (endY - startY)
        max_endY = endY
        max_endX = endX
        max_startX = startX
        max_startY = startY
        max_out = output
    #cv2.rectangle(max_out, (max_startX, max_startY), (max_endX, max_endY),(0, 0, 255), 2)
